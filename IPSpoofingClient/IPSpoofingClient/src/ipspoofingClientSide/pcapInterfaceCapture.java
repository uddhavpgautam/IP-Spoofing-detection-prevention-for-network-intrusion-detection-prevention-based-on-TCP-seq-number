...
public class pcapInterfaceCapture extends Thread {
    ...
    pcapInterfaceCapture(String macParameter, boolean threadCheckBool) {
        ...
        try {
            this.out = new PrintWriter("captureFileClient.txt");
        ...
        while (threadCheckBool) {
            ...
            for (PcapIf devicePcap : alldevs) {
                try {
                    ...
                    choose = sb.toString();
                    sb = null;
                    System.out.println("Macparameter is: " + macParameter);
                    System.out.println("Chosen is:" + choose);
            ...
            System.out.printf("Choosing '%s'\n", (selectedDevice.getName() != null) ? selectedDevice.getName() : null);
            ...
            jpacketHandler = new PcapPacketHandler<String>() {
                ...
                public void nextPacket(PcapPacket packet, String user) {
                    ...
                    ClientInterfaceIPSpoofing.outputJTextArea.append(dateStr + source + tcpPortSrc1 + tcpSeqNo + dst + tcpPortDst1 + captPack + origPack + "\n");
                }
            };

            pcap.loop(25, jpacketHandler, "");
            pcap.close();
